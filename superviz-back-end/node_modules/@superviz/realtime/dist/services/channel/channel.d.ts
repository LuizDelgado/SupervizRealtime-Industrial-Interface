import { RealtimeMessage, RealtimePublish, RealtimeChannelSubscribe } from '../../component/types';
...
export declare class Channel extends Observable {
    ...
    constructor(name: string, ioc: IOC, localParticipant: Participant, connectionLimit: number | 'unlimited');
     ...
     */
    subscribe: RealtimeChannelSubscribe;
    /**
     ...
     */
    unsubscribe: RealtimeChannelSubscribe;
    /**
